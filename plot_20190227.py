def plot_pair(var,ecotype_num=1,**kwargs):
    ...
    plot_var_PFTs(var,vegdata_PFTs_oldparams,ecotype_num,ax=subplot_handles[var+'_old'],**kwargs)
    plot_var_PFTs(var,vegdata_PFTs_newparams,ecotype_num,ax=subplot_handles[var+'_new'],**kwargs)
...
heightfig=plot_pair('HTOP',weight_area=False,maxyear=maxyear)
leaffig=plot_pair('LEAFC',obsdata=meas_leaf_C,maxyear=maxyear)
meas_root_C=Koug_meas_biomass['FineRootBiomass_gperm2'][:,'mixed']*(Koug_meas_chem['FineRootC_percent']/100)
frootfig=plot_pair('FROOTC',obsdata=meas_root_C,maxyear=maxyear,plotsum=True)
