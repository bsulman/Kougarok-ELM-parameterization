...
#ncrcat $MYSCRATCH/$simname/run/*.h3.*.nc /nfs/data/ccsi/b0u/Kougarok/$archname/${archname}_h3.nc
#ncrcat $MYSCRATCH/$simname/run/*.h4.*.nc /nfs/data/ccsi/b0u/Kougarok/$archname/${archname}_h4.nc

$HOME/plotting_py3_env/bin/python plot_kougarok.py /nfs/data/ccsi/b0u/Kougarok/$archname/${archname}_h2.nc --biomass --save_figs /nfs/data/ccsi/b0u/Kougarok/$archname
